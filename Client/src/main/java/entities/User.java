...
public class User implements EntityDB, Serializable
{
    ...
    public Boolean comparePassword(String toCompare) { return (Boolean) this.password.equals(toCompare); }
    public Boolean compareLogin(String toCompare) { return (Boolean) this.login.equals(toCompare); }
