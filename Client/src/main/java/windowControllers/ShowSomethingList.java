...
public class ShowSomethingList {
    ...
    private void drawTable()
    {
        ...
        try
        {
            ...
            switch (opt)
            {
                case MOVIES -> { req = Requests.SHOW_MOVIES; somethingLabel.setText("movies"); }
                case CINEMAS -> { req = Requests.SHOW_CINEMAS; somethingLabel.setText("cinemas"); }
                case HALLS -> {
                    req = Requests.SHOW_HALLS_FROM_CINEMA;
                    request.setObject(ClientSocket.getInstance().getCinema().getID());
                    somethingLabel.setText("halls");
                }
            }
